...
/**
   ...
   I created a black hole so #SFZ token will deflate itself in supply with every transaction
...
contract SafeZoo is Context, IBEP20, Ownable {
    ...
    string private _name = "Safezoo Token";
    string private _symbol = "SFZ";
   ...
   */
    ...
    //to recieve ETH from IPancakeRouter02 when swaping
